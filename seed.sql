...
INSERT INTO users (name, username, email, profile_img, birthday, joining_reason, followers_number, followings_number) VALUES
('Pamela', 'abrpam', 'pamela@pamela.org', 'https://i.imgur.com/3hX8kUS.jpg', '10261996', 'Talking about these conversations is important to me!', 2, 2),  
('Jo', 'designdyke', 'jo@jo.com', 'https://www.popsci.com/sites/popsci.com/files/styles/1000_1x_/public/images/2017/10/terrier-puppy.jpg?itok=rIgh3ArV&fc=50,50', '08111996', 'This is so cool!', 1, 1),
('Rupa', 'rupa1216', 'rupa@rupa.com', 'https://williamsburgvets.com/wp-content/uploads/2018/03/bulldog-puppy-pic.jpg', '12161988', "Why didn't this exist before?", 1, 1),
('Thinx', 'thinx', 'thinx@thinx.com', 'https://mindbodygreen-res.cloudinary.com/images/w_767,q_auto:eco,f_auto,fl_lossy/ptr/QpbufLD/thinx.png', '12161988', "A company like ours want to be a part of this conversation", 0, 0)

INSERT INTO posts (user_id, tag_id, content_url, title, summary, caption, likes) VALUES
...
INSERT INTO comments (user_commented_id, post_commented_id, message) VALUES
(1, 3, 'I WANT ONE! ✋'),
(3, 3, 'ME TOO! 🙋🙋🙋'),
...
INSERT INTO notifications (user_action_id, type, follower_action_id, like_action_id, comment_action_id) VALUES
(1, 'commented', NULL, NULL, 1),
(3, 'commented', NULL, NULL, 2),
(2, 'commented', NULL, NULL, 3),
(3, 'commented', NULL, NULL, 4),
(1, 'followed', 1, NULL, NULL),
(1, 'followed', 2, NULL, NULL),
(2, 'followed', 3, NULL, NULL),
(3, 'followed', 4, NULL, NULL),
(1, 'liked', NULL, 1, NULL),
(3, 'liked', NULL, 2, NULL),
(4, 'liked', NULL, 3, NULL)
